...
class RiskAnalyzer:
    ...
    def compute(self, returns: np.ndarray, benchmark: Optional[np.ndarray] = None,
        ...
        Args:
            returns: daily return series (e.g., 252 trading days)
            benchmark: benchmark daily returns (optional, for alpha/beta)
        ...
        # M²
        m_squared = self.RISK_FREE_RATE + sharpe * (0.15 - self.RISK_FREE_RATE)  # market vol = 15%
